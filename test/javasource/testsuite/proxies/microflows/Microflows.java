...
public class Microflows
{
	...
	public static testsuite.proxies.DOB dSO_DOB(IContext context)
	{
		try
		{
			Map<String, Object> params = new HashMap<String, Object>();
			IMendixObject result = (IMendixObject)Core.execute(context, "TestSuite.DSO_DOB", params);
			return result == null ? null : testsuite.proxies.DOB.initialize(context, result);
		}
		catch (CoreException e)
		{
			throw new MendixRuntimeException(e);
	...
	public static void iVK_LangChange(IContext context)
	{
		try
		{
			Map<String, Object> params = new HashMap<String, Object>();
			Core.execute(context, "TestSuite.IVK_LangChange", params);
		}
		catch (CoreException e)
		{
			throw new MendixRuntimeException(e);
